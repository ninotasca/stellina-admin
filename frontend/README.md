...
API requests use same-origin URLs. See [LOGGING.md](./LOGGING.md) for the selected
logging routes, server configuration, route inventory and verification steps.
